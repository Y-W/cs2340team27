...
public class Communication {
	...
	public LogStatus loginAttempt(String username, String password)
		...
		if (data.get(query + "/PASSWORD").equals(password)) {
			...
			data.put(query + "/COUNTER", Integer.valueOf(locknum).toString());
			submit();
			return LogStatus.FAILURE;
		}
	}
	...
	public boolean createAccount(String username, String password,
			String realname, String phone, boolean priviliged)
			throws IOException, ClassNotFoundException {
		...
		if (data.get(query) == null) {
			...
			if (priviliged) {
				if (data.get("AdminList") == null)
					data.put("AdminList", "");
				String adminlist = data.get("AdminList");
				if (adminlist != null && !adminlist.equals("")) {
					adminarr = (ArrayList<String>) deserialize(adminlist,
							adminarr);
				}
	 ...
	 * 
	 * @param email
	 *            The email of the user to be unlocked
	 */
	public void unlockUser(String email) {
		if (data.get("USER/" + email + "/COUNTER") == null)
			return;
		else
			data.put("USER/" + email + "/COUNTER", "0");
		submit();
	}
	 ...
	 *            The ArrayList to be serialized
	 * @param delimiter
	 *            The delimiter to be added between entries
	 * @return serializing result
	 */
	 ...
	 *            The String to be deserialized
	 * @param ret
	 *            Any date object for overriding need
	 * @return deserializing result
	 ...
	 *            The String to be deserialized
	 * @param ret
	 *            Any arraylist object for overriding need
	 * @return deserializing result
	 */
	 ...
	 *            Any arraylist object for overriding need
	 * @param delimiter
	 *            The delimiter that is between entries
	 * @return deserializing result
	 */
	public ArrayList<String> deserialize(String str, ArrayList<String> ret,
			String delimiter) {
	 ...
	 * 
	 * @param username
	 *            The email address of the user to whom the item is added
	 * @param item
	 ...
	 * 
	 * @param email
	 *            : the email address of the user of item.
	 * @param item
	 ...
	 *             : when class not found
	 * @throws ParseException
	 *             : when parsing error happens
	 */
	public void removeItem(String email, Item item) throws IOException,
	 ...
	 *             when class not found
	 */
	public ArrayList<String> getItems(String username) throws IOException,
			ClassNotFoundException {
		return deserialize(data.get(username + "/ITEMS"),
	 ...
	 *             when class not found
	 */
	public Item deserializeItem(String str) throws ParseException, IOException,
			ClassNotFoundException {
		if (str == null || str.equals("[]") || str.equals(""))
			return null;
		ArrayList<String> sarr = deserialize(str, new ArrayList<String>(),
				"%item%");
	 ...
	 *             when class not found
	 */
	public User deserializeUser(String str) throws IOException,
			ClassNotFoundException {
		if (str == null || str.equals("[]"))
			return null;
		ArrayList<String> sarr = deserialize(str, new ArrayList<String>(),
	...
	public ArrayList<User> getUserList() throws IOException,
		...
		if (data.get("Users") == null)
			data.put("Users", "");
		ArrayList<String> namearr = deserialize(data.get("Users"),
				new ArrayList<String>());
