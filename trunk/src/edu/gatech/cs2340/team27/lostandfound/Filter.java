...
public class Filter extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cateAdapter = new ArrayAdapter<String>(this,
		...
		statusAdapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, itemStatus);
	 ...
	 *             throw when parse is incorrect
	 */
	public void filterItems(View view) throws IOException,
		...
		name = ((TextView) (this.findViewById(R.id.editText1))).getText()
				.toString();
		if (!filterStatus) {
			status = null;
		}
		...
		DisplayItem.setList(Items.getInstance()
				.filter(cate, date, status, name));
