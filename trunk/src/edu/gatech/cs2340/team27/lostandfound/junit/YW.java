...
public class YW {
	...
	public static void setUp() throws IOException, ClassNotFoundException,
		...
		Date d = new Date();
		Items.getInstance().addItem(Item.ItemStatus.FOUND, "a", "aa", "aaa", d,
				new User("A", "1", "EA", false), Item.Category.ANIMAL);
	...
	@Test
	public void testFilter1() throws IOException, ClassNotFoundException,
			ParseException {
		assertEquals(Items.getInstance().filter(null, null, null, "a").size(),
				1);
	}

	@Test
	public void testFilter2() throws IOException, ClassNotFoundException,
			ParseException {
		assertEquals(
				Items.getInstance()
						.filter(Item.Category.CLOTH, null, null, null).size(),
				1);
	}

	@Test
	public void testFilter3() throws IOException, ClassNotFoundException,
			ParseException {
		Date tmp = new Date();
		tmp.setYear(2100);
	...
	@Test
	public void testFilter4() throws IOException, ClassNotFoundException,
			ParseException {
		assertEquals(
				Items.getInstance()
						.filter(null, null, Item.ItemStatus.LOST, null).size(),
				1);
	}

	@Test
	public void testFilter5() throws IOException, ClassNotFoundException,
			ParseException {
		assertEquals(Items.getInstance().filter(null, null, null, null).size(),
				3);
		assertEquals(
				Items.getInstance()
						.filter(Item.Category.ANIMAL, d, Item.ItemStatus.FOUND,
								"A").size(), 1);
	}
}
