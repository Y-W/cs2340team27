...
public class Admin extends User {
	 ...
	 * 
	 * @param user
	 *            The user to be generated to admin
	 */
	public Admin(User user) {
		super(user.getName(), user.getPhoneNumber(), user.getEmail(), user
				.isLocked());
	}
	 ...
	 *             throw when class is not found
	 */
	public void unlockUser(String email) throws IOException,
			ClassNotFoundException {
	 ...
	 * 
	 * @param email
	 *            the email of the new admin
	 * @param password
	 *            the password of the new admin
	 * @param realname
	 *            the realname of the new admin
	 * @param phone
	 *            the phone number of the new admin
	 ...
	 *             throw when class is not found
	 */
	public boolean addAdmin(String email, String password, String realname,
			String phone) throws IOException, ClassNotFoundException {
		return Communication.getInstance().createAccount(email, password,
				realname, phone, true);
	}
}
